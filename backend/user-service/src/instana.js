// Instana tracing initialization for User Service
...
require('@instana/collector')({
  ...
  serviceName: process.env.INSTANA_SERVICE_NAME || 'robot-shop-user',
  tags: {
...
console.log('Instana tracing initialized for User Service');
