// Instana tracing initialization for Inventory Service
...
require('@instana/collector')({
  ...
  serviceName: process.env.INSTANA_SERVICE_NAME || 'robot-shop-inventory',
  tags: {
...
console.log('Instana tracing initialized for Inventory Service');
